...
INSERT INTO Mission (mission_start, mission_end, FK_location, FK_company, FK_contact, FK_report, FK_meeting) VALUES (SYSDATE, SYSDATE, 1, 1, 1, 1, 1);
INSERT INTO Mission (mission_start, mission_end, FK_location, FK_company, FK_contact, FK_report, FK_meeting) VALUES (SYSDATE, SYSDATE, 2, 2, 2, 2, 2);
INSERT INTO Mission (mission_start, mission_end, FK_location, FK_company, FK_contact, FK_report, FK_meeting) VALUES (SYSDATE, SYSDATE, 3, 3, 3, 3, 3);
INSERT INTO Mission (mission_start, mission_end, FK_location, FK_company, FK_contact, FK_report, FK_meeting) VALUES (SYSDATE, SYSDATE, 4, 4, 4, 4, 4);
INSERT INTO Mission (mission_start, mission_end, FK_location, FK_company, FK_contact, FK_report, FK_meeting) VALUES (SYSDATE, SYSDATE, 5, 5, 5, 5, 5);

INSERT INTO Meeting (id_meeting, meeting_timestamp, meeting_title, meeting_debriefing, FK_location) VALUES (1, '', 'title 1', 'debriefing 1', 1);
INSERT INTO Meeting (id_meeting, meeting_timestamp, meeting_title, meeting_debriefing, FK_location) VALUES (2, '', 'title 2', 'debriefing 2', 2);
INSERT INTO Meeting (id_meeting, meeting_timestamp, meeting_title, meeting_debriefing, FK_location) VALUES (3, '', 'title 3', 'debriefing 3', 3);
INSERT INTO Meeting (id_meeting, meeting_timestamp, meeting_title, meeting_debriefing, FK_location) VALUES (4, '', 'title 4', 'debriefing 4', 4);
INSERT INTO Meeting (id_meeting, meeting_timestamp, meeting_title, meeting_debriefing, FK_location) VALUES (5, '', 'title 5', 'debriefing 5', 5);
...
INSERT INTO Difficulty_Type (id_difficulty_type, title_difficulty_type) VALUES (1, 'difficulty type 1');
INSERT INTO Difficulty_Type (id_difficulty_type, title_difficulty_type) VALUES (2, 'difficulty type 2');
INSERT INTO Difficulty_Type (id_difficulty_type, title_difficulty_type) VALUES (3, 'difficulty type 3');
INSERT INTO Difficulty_Type (id_difficulty_type, title_difficulty_type) VALUES (4, 'difficulty type 4');
INSERT INTO Difficulty_Type (id_difficulty_type, title_difficulty_type) VALUES (5, 'difficulty type 5');
...
INSERT INTO Test_Result (id_test_result, test_result_log, test_state) VALUES (1, 'test result 1', 'test state 1');
INSERT INTO Test_Result (id_test_result, test_result_log, test_state) VALUES (2, 'test result 2', 'test state 2');
INSERT INTO Test_Result (id_test_result, test_result_log, test_state) VALUES (3, 'test result 3', 'test state 3');
INSERT INTO Test_Result (id_test_result, test_result_log, test_state) VALUES (4, 'test result 4', 'test state 4');
INSERT INTO Test_Result (id_test_result, test_result_log, test_state) VALUES (5, 'test result 5', 'test state 5');

INSERT INTO Test (id_test, test_start, start_end, FK_report, FK_tool, FK_test_type, FK_methodology, FK_test_result, FK_employe, FK_recomendation, FK_difficulty, FK_difficulty_type) VALUES (SYSDATE, SYSDATE, 1, 1, 1, 1, 1, 1, 1, 1, 1);
INSERT INTO Test (id_test, test_start, start_end, FK_report, FK_tool, FK_test_type, FK_methodology, FK_test_result, FK_employe, FK_recomendation, FK_difficulty, FK_difficulty_type) VALUES (SYSDATE, SYSDATE, 2, 2, 2, 2, 2, 2, 2, 2, 2);
INSERT INTO Test (id_test, test_start, start_end, FK_report, FK_tool, FK_test_type, FK_methodology, FK_test_result, FK_employe, FK_recomendation, FK_difficulty, FK_difficulty_type) VALUES (SYSDATE, SYSDATE, 3, 3, 3, 3, 3, 3, 3, 3, 3);
INSERT INTO Test (id_test, test_start, start_end, FK_report, FK_tool, FK_test_type, FK_methodology, FK_test_result, FK_employe, FK_recomendation, FK_difficulty, FK_difficulty_type) VALUES (SYSDATE, SYSDATE, 4, 4, 4, 4, 4, 4, 4, 4, 4);
INSERT INTO Test (id_test, test_start, start_end, FK_report, FK_tool, FK_test_type, FK_methodology, FK_test_result, FK_employe, FK_recomendation, FK_difficulty, FK_difficulty_type) VALUES (SYSDATE, SYSDATE, 5, 5, 5, 5, 5, 5, 5, 5, 5);